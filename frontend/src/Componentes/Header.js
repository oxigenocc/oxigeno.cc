    ...
    return(<>
        <div className="Header" >
            ...
            <div className="HeaderBotonesRedes animate__animated animate__fadeIn animate__duration-1s animate__delay-1s" >
                <a href={`https://facebook.com/sharer/sharer.php?u=${link}`} target="_blank" rel="noreferrer" aria-label="Share on Facebook" className="HeaderFacebook" >
                ...
                <a className="HeaderWhatsapp" href={`https://api.whatsapp.com/send?text=${link}`} target="_blank" rel="noreferrer" >
                    <WhatsAppIcon className="logowhatsapp" />
                    <div>Compartir</div>
                </a>
                <a className="HeaderTwitter" href={`https://twitter.com/intent/tweet/?text=Informaci%C3%B3n%20actualizada%20todos%20los%20d%C3%ADas%20para%20comprar%2C%20rentar%20o%20recargar%20tanques%20de%20ox%C3%ADgeno%20en%20la%20Ciudad%20de%20M%C3%A9xico.&amp;url=${link}`} target="_blank" rel="noreferrer" aria-label="Share on Twitter">
